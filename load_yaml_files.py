...
print "Created graph of 'Congressman - [co-membership of committee] - Congressman'"
print "Graph has %d nodes and %d edges" % (G.GetNodes(), G.GetEdges())
print "Its clustering co-efficient is %f" % (snap.GetClustCf(G))

snap.SaveEdgeList(G, 'co-membership_of_committees.txt', 'Graph of Congressman - [co-membership of committee] - Congressman with 537 nodes and 19417 edges')
print 'Saved the graph'

snap.PrintInfo(G, "Information for original graph on co-membership of committees", "info-comembership_of_committees.txt", False)
